...
//     { label: "Indexed Chunks", value: backendStats.total_chunks || "1745", icon: "fa-database", color: "text-blue-500" },
//     { label: "Library Size", value: backendStats.library_size || library.length, icon: "fa-book", color: "text-cyan-500" },
//     { label: "Queries", value: "0", icon: "fa-comments", color: "text-sky-500" },
//     { label: "Avg Latency", value: "0.00s", icon: "fa-clock", color: "text-indigo-500" },
//   ];
...
//           <h2 className="text-xl font-bold tracking-tight text-slate-800 dark:text-white">Dashboard Overview</h2>
//         </div>
...
//             <h3 className="text-lg font-semibold text-slate-800 dark:text-white">Knowledge Acquisition</h3>
//           </div>
...
//             </div>
//             <p className="font-medium text-slate-600 dark:text-slate-300">Drag & drop PDFs here</p>
//             <p className="text-[10px] mt-2 uppercase font-bold tracking-widest text-slate-400 dark:text-slate-600">or click to browse</p>
...
//             </button>
//           </div>
//           {status && <div className="mt-6 text-center text-[10px] font-bold text-blue-500 dark:text-blue-400 uppercase tracking-widest">{status}</div>}
//         </div>
...
//             <h3 className="text-lg font-semibold text-slate-800 dark:text-white">Document Library</h3>
//           </div>
...
//                         {doc.size} <span className="mx-1 opacity-30">|</span> {doc.chunks}
//                       </p>
//                     </div>
//                   </div>
