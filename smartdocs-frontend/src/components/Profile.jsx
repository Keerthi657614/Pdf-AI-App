...
// //   const [formData, setFormData] = useState({ newUsername: user, newPassword: "" });
...
// //       onUpdate(res.data.username); // Update global state
// //     } catch (err) {
...
// //           <h2 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Account Settings</h2>
// //           <p className="text-slate-500 text-sm mt-1">Manage your enterprise identity and security</p>
// //         </header>
...
// //               <input 
// //                 className="w-full bg-slate-50 dark:bg-[#030712] border border-slate-200 dark:border-slate-800 rounded-2xl py-4 px-6 text-sm mt-1.5 focus:border-blue-500 outline-none transition"
...
// //             type="submit" 
// //             disabled={loading}
// //             className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-2xl font-bold text-sm shadow-lg shadow-blue-500/20 transition-all active:scale-95"
// //           >
// //             {loading ? <i className="fas fa-circle-notch fa-spin mr-2" /> : <i className="fas fa-save mr-2" />}
// //             Save Changes
// //           </button>
// //         </form>
// //       </div>
...
//       // 2️⃣ Upload profile picture (after username update)
//       await uploadProfilePic(updatedUser);

//       // 3️⃣ Update local storage
//       localStorage.setItem("user", updatedUser);

//       // 4️⃣ Notify parent + header
...
//             <div className="w-24 h-24 rounded-full overflow-hidden border border-slate-300 dark:border-slate-700">
//               {preview ? (
//                 <img
//                   src={preview}
//                   alt="Profile"
...
//               className="w-full bg-slate-50 dark:bg-[#030712]
//                          border border-slate-200 dark:border-slate-800
//                          rounded-2xl py-4 px-6 text-sm mt-1.5
